...
for local_file_to_install in $local_files_to_install
    if test -f $local_file_to_install
        ...
        set string_ssh_command $string_ssh_command 'sudo mv ~/'$file_to_install_basename' /usr/local/bin/'$file_to_install_basename' ; sudo chmod a+x /usr/local/bin/'$file_to_install_basename' ; sudo chown root:root /usr/local/bin/'$file_to_install_basename' ; '
